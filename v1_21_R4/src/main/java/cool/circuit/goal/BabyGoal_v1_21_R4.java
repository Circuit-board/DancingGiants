...
public class BabyGoal_v1_21_R4 extends PathfinderGoal {
    private final EntityGiantZombie adult;
    private final EntityZombie baby;
    private int ticks = 0;

    public BabyGoal_v1_21_R4(EntityGiantZombie adult, EntityZombie baby) {
        this.adult = adult;
        this.baby = baby;
        baby.a(true);
    }
    ...
    public void baby() {
        EntityGiantZombie giant = new EntityGiantZombie(EntityTypes.af, adult.dV());
        giant.bF.a(0, new DanceGoal_v1_21_R4(giant));
        if(getSwings().get(adult)) {
            SwingGoal_v1_21_R4 goal = new SwingGoal_v1_21_R4(giant);
        ...
        adult.dV().addFreshEntity(giant, CreatureSpawnEvent.SpawnReason.COMMAND);
