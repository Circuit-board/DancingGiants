...
import cool.circuit.goal.BabyGoal_v1_21_R4;
import cool.circuit.goal.BabyGrowGoal_v1_21_R4;
import cool.circuit.goal.DanceGoal_v1_21_R4;
...
public class GiantCommand_v1_21_R4 implements TabExecutor {
    ...
    private boolean handleArgs(Player player, String[] args) {
        if (args.length == 0) {
            ...
            if (Math.random() > 0.5) {
                ...
                EntityGiantZombie giant = new EntityGiantZombie(EntityTypes.af, ((CraftWorld) player.getWorld()).getHandle());
                giant.a_(player.getLocation().getX(), player.getLocation().getY(), player.getLocation().getZ());

                SwingGoal_v1_21_R4 swingGoal = new SwingGoal_v1_21_R4(giant);
                ...
                giant.bF.a(1, new PathfinderGoalRandomLookaround(giant));
                ...
                EntityZombie zombie = new EntityZombie(EntityTypes.bP, ((CraftWorld) player.getWorld()).getHandle());
                ...
                zombie.bF.a(0, new DanceGoal_v1_21_R4(zombie));
                zombie.bF.a(1, new PathfinderGoalRandomLookaround(zombie));
                zombie.bF.a(2, new PathfinderGoalRandomStroll(zombie, 1.0));
                zombie.bF.a(3, new BabyGrowGoal_v1_21_R4(zombie));

                ((CraftWorld) player.getWorld()).getHandle().addFreshEntity(zombie, CreatureSpawnEvent.SpawnReason.COMMAND);

                ENTITY_IDS.add(zombie.ao());
            }
        }
        ...
        if (args.length == 2 && args[0].equalsIgnoreCase("kill")) {
            try {
                ...
                entity.c(((CraftWorld) player.getWorld()).getHandle());
        ...
        if (args.length == 2 && args[0].equalsIgnoreCase("hostile")) {
            try {
                ...
                if (isHostile) {
                    giant.bF.a(g -> g instanceof PathfinderGoalMeleeAttack);
                    giant.bG.a(g -> g instanceof PathfinderGoalNearestAttackableTarget<?>);

                    hostiles.put(giant, false);
                    player.sendMessage(ChatColor.GREEN + "Giant with ID " + id + " is no longer hostile.");
                } else {
                    giant.bF.a(2, new PathfinderGoalMeleeAttack(giant, 1.0, true));
                    giant.bG.a(0, new PathfinderGoalNearestAttackableTarget<>(giant, net.minecraft.world.entity.player.EntityHuman.class, true));
        ...
        if (args.length == 1 && args[0].equalsIgnoreCase("family")) {
            ...
            //Spawn adult
            EntityGiantZombie adult = new EntityGiantZombie(EntityTypes.af, ((CraftWorld) player.getWorld()).getHandle());
            adult.a_(player.getLocation().getX(), player.getLocation().getY(), player.getLocation().getZ());

            SwingGoal_v1_21_R4 swingGoal = new SwingGoal_v1_21_R4(adult);
            swingGoal.setSwinging(false);
            ...
            adult.bF.a(0, new DanceGoal_v1_21_R4(adult));
            adult.bF.a(1, new PathfinderGoalRandomLookaround(adult));
            adult.bF.a(2, new PathfinderGoalRandomStroll(adult, 1.0));

            ((CraftWorld) player.getWorld()).getHandle().addFreshEntity(adult, CreatureSpawnEvent.SpawnReason.COMMAND);

            ENTITY_IDS.add(adult.ao());

            //Spawn baby
            EntityZombie baby = new EntityZombie(EntityTypes.bP, ((CraftWorld) player.getWorld()).getHandle());
            ...
            baby.bF.a(0, new DanceGoal_v1_21_R4(baby));
            baby.bF.a(1, new PathfinderGoalRandomLookaround(baby));
            baby.bF.a(2, new BabyGoal_v1_21_R4(adult, baby));

            ((CraftWorld) player.getWorld()).getHandle().addFreshEntity(baby, CreatureSpawnEvent.SpawnReason.COMMAND);

            ENTITY_IDS.add(baby.ao());
        }
